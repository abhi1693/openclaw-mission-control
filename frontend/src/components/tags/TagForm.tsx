  ...
  return (
    ...
    >
      <div className="space-y-5">
        <div className="rounded-xl border border-[color:var(--border)] bg-[color:var(--surface-muted)]/60 p-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <button
                  ...
                  className="text-xs font-medium text-muted underline underline-offset-2 transition hover:text-muted disabled:cursor-not-allowed disabled:opacity-50"
        ...
        {errorMessage ? (
          <div className="rounded-lg border border-rose-200 bg-rose-50 p-3 text-sm text-[color:var(--danger)]">
            {errorMessage}
          </div>
        ) : null}
      </div>
