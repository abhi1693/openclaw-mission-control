...
const columns: Array<{
...
}> = [
  {
    ...
    badge: "bg-[color:var(--surface-muted)] text-muted",
  },
  {
    title: "In Progress",
    status: "in_progress",
    dot: "bg-purple-500",
    accent: "hover:border-purple-400/80 hover:bg-purple-500/10",
    text: "group-hover:text-purple-300 text-muted",
  ...
  },
  {
    ...
    status: "review",
    dot: "bg-indigo-500",
    accent: "hover:border-indigo-400/80 hover:bg-indigo-500/10",
    text: "group-hover:text-indigo-300 text-muted",
  ...
  },
  {
    ...
    status: "done",
    dot: "bg-green-500",
    accent: "hover:border-emerald-400/80 hover:bg-emerald-500/10",
    text: "group-hover:text-emerald-300 text-muted",
