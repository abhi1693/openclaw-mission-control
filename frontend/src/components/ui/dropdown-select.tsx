            ...
            {options.map((option) => {
              ...
              return (
                <CommandItem
                  ...
                  className={cn(
                    "flex items-center justify-between gap-2 rounded-lg px-4 py-3 text-sm text-strong transition-colors data-[selected=true]:bg-[color:var(--surface-strong)]/60 data-[selected=true]:text-strong",
                    isSelected && "font-semibold",
                    !isSelected && "hover:bg-[color:var(--surface-strong)]/55",
                    itemClassName,
                  )}
                >
