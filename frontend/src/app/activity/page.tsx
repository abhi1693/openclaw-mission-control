...
const eventPillClass = (eventType: FeedEventType): string => {
  ...
  return "border-[color:var(--border)] bg-slate-100 text-strong";
};
...
const FeedCard = memo(function FeedCard({
  ...
  return (
    <div
      ...
      className={cn(
        "scroll-mt-28 rounded-xl border bg-[color:var(--surface-muted)] p-4 transition",
        isHighlighted
    ...
    >
      <div className="flex items-start gap-3">
        <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 text-xs font-semibold text-strong">
          {authorAvatar}
        </div>
        ...
        <>
          ...
          <SignedIn>
            ...
            <main className="flex-1 overflow-y-auto bg-[color:var(--surface-muted)]">
              <div className="sticky top-0 z-30 border-b border-[color:var(--border)] bg-[color:var(--surface-muted)]">
