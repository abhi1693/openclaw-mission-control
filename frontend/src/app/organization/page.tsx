  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <div className="mt-3 inline-flex rounded-xl border border-[color:var(--border)] bg-[color:var(--surface-strong)]/60 p-1">
          <button
            type="button"
            className={cn(
              "rounded-md px-3 py-1.5 text-xs font-semibold transition",
              scope === "all"
                ? "bg-[color:var(--surface-strong)] text-strong shadow-sm"
