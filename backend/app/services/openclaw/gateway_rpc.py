...
def _build_device_auth(
    *,
    ...
    payload = f"v2|{device_id}|gateway-client|ui|operator|{scopes_str}|{signed_at}|{token}|{nonce}"
...
def _build_connect_params(config: GatewayConfig, *, nonce: str = "") -> dict[str, Any]:
