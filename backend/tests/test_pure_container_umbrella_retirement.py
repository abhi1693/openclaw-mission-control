...
async def test_pure_container_umbrella_not_retired_without_marker(
    ...
    """No UMBRELLA_RETIRED marker comment → must NOT auto-cancel.
    The marker is the lead's explicit commitment that the container is
    decomposition-completed; absent that, the safety net holds."""
